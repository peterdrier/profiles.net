...
/// </list>
/// </summary>
public sealed class IbanAccessRequirement : IAuthorizationRequirement
{
    /// <summary>
    ...
    /// </summary>
    public bool IsAdminPageContext { get; }

    public IbanAccessRequirement(Guid targetUserId, Guid? reportId = null, bool isAdminPageContext = false)
    {
        TargetUserId = targetUserId;
        ReportId = reportId;
        IsAdminPageContext = isAdminPageContext;
    }
}
