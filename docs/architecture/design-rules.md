...
- **26 repositories** exist today (the dedicated `TicketingBudgetRepository` was removed in #815 — the Tickets→Budget bridge is now repository-free). Target: one per domain (~20 total, some sections need two):
