...
- [Authentication](../auth/authentication.md) - Profile created after first login
- [Volunteer Status](../onboarding/volunteer-status.md) - Computed from profile approval + consents
- [Contact Fields](../profiles/contact-fields.md) - Granular contact info visibility
- [Administration](../global/administration.md) - Admin member management
- [Profile Pictures & Birthdays](../profiles/profile-pictures-birthdays.md) - Custom profile pictures and birthday calendar
