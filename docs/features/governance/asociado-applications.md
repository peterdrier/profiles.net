...
- See [Board Voting](../governance/board-voting.md) for full voting workflow
...
5. **Board Votes on Applications**: See [Board Voting](../governance/board-voting.md)
...
- [Onboarding Pipeline](../onboarding/onboarding-pipeline.md) — End-to-end onboarding flow
- [Board Voting](../governance/board-voting.md) — Board voting process
- [Coordinator Roles](../shifts/coordinator-roles.md) — Consent check (Volunteer gate, separate from applications)
- [Profiles](../profiles/profiles.md) — Profile data
- [Administration](../global/administration.md) — Application management
