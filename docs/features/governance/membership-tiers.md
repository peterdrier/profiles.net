...
- [Onboarding Pipeline](../onboarding/onboarding-pipeline.md) — How tier selection fits into the signup flow
- [Tier Applications](../governance/asociado-applications.md) — Application entity and state machine
- [Board Voting](../governance/board-voting.md) — How the Board decides on tier applications
- [Coordinator Roles](../shifts/coordinator-roles.md) — Consent check gate (Volunteer only)
- [Teams](../teams/teams.md) — Volunteers, Colaboradors, Asociados system teams
