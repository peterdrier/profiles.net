...
Board voting only applies to tier applications (Colaborador and Asociado). Volunteer access is handled automatically through the consent check gate — see [Onboarding Pipeline](../onboarding/onboarding-pipeline.md).
...
- [Membership Tiers](../governance/membership-tiers.md) — Tier definitions and term lifecycle
- [Onboarding Pipeline](../onboarding/onboarding-pipeline.md) — Where Board voting fits in the pipeline
- [Coordinator Roles](../shifts/coordinator-roles.md) — Consent check gate (separate from Board voting)
- [Tier Applications](../governance/asociado-applications.md) — Application entity and state machine
- [Administration](../global/administration.md) — Admin role and access
